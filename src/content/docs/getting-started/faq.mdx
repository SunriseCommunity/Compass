...
## How to make some beatmap statuses eligable/ineligable for hyping?
...
Valid statuses are: `Graveyard`, `Wip`, `Pending`, `Ranked`, `Approved`, `Qualified`, `Loved`.
