---
title: Installation - Without Orchestrator
sidebar:
   order: 1
   badge:
      text: Deprecated
...
If you would like to give you admin privileges to your account, or generally want to know how to manage the server, check out the [Configuration](/docs/configuration) section.
