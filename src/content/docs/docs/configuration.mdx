...
![Admin Panel](../../../assets/img/admin-button.png)
...
![Cloudflare GeoIP](../../../assets/img/cloudflare-geo.png)

:::caution
Make sure you also have `IP Geolocation` enabled in the Cloudflare network settings.

![Cloudflare IP Geolocation](../../../assets/img/cloudflare-ip-geo.png)
:::
...
![Beatmap Management](../../../assets/img/beatmap-ranking.png)
...
By default, the server is configured to pull beatmaps from Bancho (if api credentials are provided), [Mino](https://catboy.best/), [osu.direct](https://osu.direct/home) and other mirrors. 
...
:::tip
If possible, please avoid removing Bancho mirror from the pool, as it is the most reliable and has the most complete data.
:::
...
<div class="video-wrapper">
  <iframe src="https://www.youtube.com/embed/usQglXdAzbA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
